// Script para converter campos em arealogada.html
// Execute este script após carregar a página no navegador

// 1. Converter Matrícula para SELECT
const matriculaDiv = document.querySelector('input#matricula').closest('.col-md-3');
const matriculaValue = document.querySelector('input#matricula').value;
matriculaDiv.innerHTML = `
    <label class="form-label">Matrícula</label>
    <select class="form-select bg-light" id="matricula" disabled>
        <option value="${matriculaValue}" selected>${matriculaValue}</option>
    </select>
`;

// 2. Converter Nacionalidade para SELECT com lista completa
const nacionalidadeDiv = document.querySelector('input#nacionalidade').closest('.col-md-4');
nacionalidadeDiv.innerHTML = `
...
console.log('Campos convertidos com sucesso!');
console.log('Matrícula: agora é SELECT');
console.log('Nacionalidade: agora é SELECT com lista completa de nacionalidades');
