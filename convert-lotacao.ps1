# Script PowerShell para converter campo Lotação em arealogada.html
...
# Converter Lotação para SELECT com lista completa de órgãos
$lotacaoOld = '<input type="text" class="form-control" required id="lotacao">'
$lotacaoNew = @'
...
'@
$content = $content.Replace($lotacaoOld, $lotacaoNew)

# Salvar o arquivo
Set-Content $filePath -Value $content -Encoding UTF8 -NoNewline

Write-Host "Conversão concluída com sucesso!"
Write-Host "- Lotação: convertido para SELECT com 36 órgãos/secretarias"
